...
public class JanelaJogo extends JanelaPadrao{
	...
	private class OuvinteBotao implements ActionListener{
		...
		public void actionPerformed(ActionEvent evento) {
				...
				qtDeJogadas += 1;
				if(vezJog1) {
					if(!matriz[Integer.parseInt(pos[0])][Integer.parseInt(pos[1])].equals("o")) {
						matriz[Integer.parseInt(pos[0])][Integer.parseInt(pos[1])] = "x";
						vezJog1 = false;
						botao.setText("X");
					...
					if(!matriz[Integer.parseInt(pos[0])][Integer.parseInt(pos[1])].equals("x")) {
						matriz[Integer.parseInt(pos[0])][Integer.parseInt(pos[1])] = "o";
						vezJog1 = true;
						botao.setText("O");
	...
	public boolean verificador(String vez) {
		//verifica linhas.
		if(matriz[0][0].equals(vez) && matriz[0][1].equals(vez) && matriz[0][2].equals(vez)) {
			return true;// se a primeira linha for toda igual o jogador venceu.
		}else if(matriz[1][0].equals(vez) && matriz[1][1].equals(vez) && matriz[1][2].equals(vez)) {
			return true;
		}else if(matriz[2][0].equals(vez) && matriz[2][1].equals(vez) && matriz[2][2].equals(vez)) {
			return true;
		//verifica colunas.
		}else if(matriz[0][0].equals(vez) && matriz[1][0].equals(vez) && matriz[2][0].equals(vez)) {
			return true;
		}else if(matriz[0][1].equals(vez) && matriz[1][1].equals(vez) && matriz[2][1].equals(vez)) {
			return true;
		}else if(matriz[0][2].equals(vez) && matriz[1][2].equals(vez) && matriz[2][2].equals(vez)) {
			return true;
		//verificar diagonais.
		}else if(matriz[0][0].equals(vez) && matriz[1][1].equals(vez) && matriz[2][2].equals(vez)) {
			return true;
		}else if(matriz[2][0].equals(vez) && matriz[1][1].equals(vez) && matriz[0][2].equals(vez)) {
			return true;
		}else {
			return false;
		}
